...
app.intent('add_expense', (conv, { expense }) => __awaiter(this, void 0, void 0, function* () {
    ...
    yield createExpense(expenseModel);
    conv.add(TRANSLATIONS.EXPENSE_ADDED_MESSAGE);
    return conv;
}));
app.intent('create_category_on_add_expense_yes', (conv) => __awaiter(this, void 0, void 0, function* () {
    yield createCategory(conv.data['inexistentCategory']);
    yield createExpense(conv.data['expenseToCreate']);
    conv.add(TRANSLATIONS.CATEGORY_ADDED_MESSAGE);
    return conv;
}));
app.intent('create_category_on_add_expense_no', (conv) => __awaiter(this, void 0, void 0, function* () {
    ...
    yield createCategory(expenseCategory);
    yield createExpense(expenseToCreate);
    conv.add(TRANSLATIONS.CATEGORY_ADDED_MESSAGE);
    return conv;
}));
app.intent('list_expense_categories', (conv) => __awaiter(this, void 0, void 0, function* () {
